...
class SVDQuantLinearMethod(LinearMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        # Mark which dimension is sharded by TP. The `RowParallel` /
        # `ColumnParallel` distinction is reflected in the layer type;
        # the loaders above already use these dims.
        del is_row_parallel, is_col_parallel  # currently unused; kept for clarity
